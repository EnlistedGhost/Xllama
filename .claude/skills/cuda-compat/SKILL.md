---
name: cuda-compat
description: Tesla K80 CUDA compatibility details. Use when working on CUDA code, CUBLAS functions, CMake CUDA configuration, or debugging GPU-specific issues in this codebase.
user-invocable: false
---

# CUDA / Tesla K80 Compatibility Reference
...
| Alderlake (2021) | alderlake | Partial | Missing AVX_VNNI only |
| Raptor Lake (2022) | alderlake | Partial | Missing AVX_VNNI only |
